...
Use Android's SRC (Kaiser-windowed sinc resampler) via AudioTrack's resampling capabilities. This provides high-quality sample rate conversion without external dependencies. Priority is audio quality over CPU efficiency.
...
fun resampleBytes(
    ...
    // Use Android SRC (Kaiser-windowed sinc resampler) via AudioTrack
    // This provides high-quality resampling suitable for voice/audio codecs
