...
class NoCallCoordinatorGetInstanceOutsideHostRuleTest {
    ...
    fun `flags qualified CallCoordinator getInstance in app source`() {
        ...
        val findings =
            findingsFor(
                source,
                "/Users/tyler/repos/columba/app/src/main/java/network/columba/app/viewmodel/CallViewModel.kt",
            )
    ...
    fun `allows CallCoordinator getInstance in rns-host source`() {
        ...
        val findings =
            findingsFor(
                source,
                "/Users/tyler/repos/columba/rns-host/src/kotlinBackend/kotlin/network/columba/app/rns/host/HostBackendModule.kt",
            )
    ...
    fun `allows CallCoordinator getInstance in rns-backend-kt source`() {
        ...
        val findings =
            findingsFor(
                source,
                "/Users/tyler/repos/columba/rns-backend-kt/src/main/kotlin/network/columba/app/rns/backend/kt/NativeCallManager.kt",
            )
    ...
    fun `ignores unrelated singleton getInstance calls`() {
        ...
        val findings =
            findingsFor(
                source,
                "/Users/tyler/repos/columba/app/src/main/java/network/columba/app/foo/Bar.kt",
            )
