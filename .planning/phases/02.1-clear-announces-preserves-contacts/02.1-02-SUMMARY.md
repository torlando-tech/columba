...
- `data/src/test/java/network.columba.app/data/db/dao/AnnounceDaoTest.kt` - Added 6 tests for SQL subquery behavior, helper functions for test entities with FK constraints
- `app/src/test/java/network.columba.app/viewmodel/AnnounceStreamViewModelTest.kt` - Updated 2 tests, added 1 new test for identity-aware delete routing
