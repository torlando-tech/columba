...
fun InterfaceManagementScreen(
    ...
    val defaultTcpServerName = stringResource(R.string.interface_management_type_tcp_server)
    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                Icon(Icons.Default.Add, contentDescription = stringResource(R.string.interface_management_add_interface))
            }
        },
    ) { paddingValues ->
        Box(
                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                ...
                                Text(
                                    stringResource(R.string.interface_management_enabled_label),
                            ...
                            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                ...
                                Text(
                                    stringResource(R.string.interface_management_total_label),
                                    style = MaterialTheme.typography.bodyMedium,
                                )
                            }
                            ...
                            if (state.isDiscoveryEnabled && state.discoveredInterfaceCount > 0) {
                                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                    ...
                                    Text(
                                        stringResource(R.string.interface_management_discovered_label),
                                        style = MaterialTheme.typography.bodyMedium,
                                    )
                                }
                            }
                ...
                when (type) {
                    ...
                    "TCPServer" -> {
                        ...
                        viewModel.updateConfigState {
                            it.copy(type = type, name = defaultTcpServerName, mode = "full")
                        }
                    }
                    else -> {
                        viewModel.showAddDialog()
...
fun InterfaceCard(
    ...
    val copiedAddressMessage = stringResource(R.string.interface_management_copied_address)
    val noNetworkLabel = stringResource(R.string.interface_management_no_network)
        ...
        Column(
                    ...
                    if (interfaceEntity.type == "TCPServer") {
                        ...
                        val copyAddress =
                            try {
                                ...
                                if (localIp != null) {
                                    formatAddressWithPort(localIp, port, isYggdrasil, noNetworkLabel)
                                } else {
                                    null
                                }
                            } catch (e: Exception) {
                            ...
                            modifier =
                                Modifier.clickable(enabled = copyAddress != null) {
                                    copyAddress?.let {
                                        ...
                                        Toast.makeText(
                                            context,
                                            copiedAddressMessage.format(it),
                                            Toast.LENGTH_SHORT,
                                        ).show()
                                    }
                                },
            ...
            Row(
                ...
                Surface(
                    ...
                    Text(
                        text = if (interfaceEntity.enabled) {
                            stringResource(R.string.interface_management_status_enabled)
                        } else {
                            stringResource(R.string.interface_management_status_disabled)
                        },
            ...
            Row(
                ...
                OutlinedButton(
                    ...
                    Text(stringResource(R.string.interface_management_edit))
                }
                ...
                OutlinedButton(
                    ...
                    Spacer(modifier = Modifier.width(4.dp))
                    Text(stringResource(R.string.interface_management_delete))
                }
            }
        }
    }
...
fun DeleteConfirmationDialog(
    ...
    AlertDialog(
        ...
        title = { Text(stringResource(R.string.interface_management_delete_dialog_title)) },
        text = {
            Text(stringResource(R.string.interface_management_delete_dialog_message, interfaceName))
        },
        confirmButton = {
            Button(
                onClick = onConfirm,
        ...
        dismissButton = {
            TextButton(onClick = onDismiss) {
                Text(stringResource(R.string.interface_management_cancel))
            }
        },
    )
}
...
fun ApplyChangesDialog() {
    AlertDialog(
        ...
        title = { Text(stringResource(R.string.interface_management_applying_changes_title)) },
        text = {
            Column(
                horizontalAlignment = Alignment.CenterHorizontally,
                modifier = Modifier.fillMaxWidth(),
                ...
                Text(
                    stringResource(R.string.interface_management_restarting_network),
                    style = MaterialTheme.typography.bodyLarge,
                )
                Spacer(Modifier.height(8.dp))
                Text(
                    stringResource(R.string.interface_management_restarting_hint),
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
            }
    ...
    AlertDialog(
        ...
        confirmButton = {
            Button(onClick = onDismiss) {
                Text(stringResource(R.string.interface_management_ok))
            }
        },
    )
}
...
internal fun getInterfaceTypeLabel(type: String): String {
    return when (type) {
        "AutoInterface" -> stringResource(R.string.interface_management_type_auto_discovery)
        "TCPClient" -> stringResource(R.string.interface_management_type_tcp_client)
        "TCPServer" -> stringResource(R.string.interface_management_type_tcp_server)
        "RNode" -> stringResource(R.string.interface_management_type_rnode)
        "UDP" -> stringResource(R.string.interface_management_type_udp)
        "AndroidBLE" -> stringResource(R.string.interface_management_type_bluetooth_le)
        else -> type
    }
}
...
private fun getInterfaceDescription(interfaceEntity: InterfaceEntity): String {
    ...
    val noNetworkLabel = stringResource(R.string.interface_management_no_network)
    val yggdrasilSuffix = stringResource(R.string.interface_management_yggdrasil_suffix)
    return when (interfaceEntity.type) {
        "TCPServer" -> {
            try {
                ...
                val (localIp, isYggdrasil) = getLocalIpAddress()
                val networkType = if (isYggdrasil) yggdrasilSuffix else ""
                val addressDisplay = formatAddressWithPort(localIp, listenPort, isYggdrasil, noNetworkLabel)
    ...
    AlertDialog(
        ...
        text = {
            Column(
                ...
                InterfaceTypeOption(
                    title = stringResource(R.string.interface_management_type_auto_discovery),
                ...
                InterfaceTypeOption(
                    title = stringResource(R.string.interface_management_type_tcp_client),
                    description = stringResource(R.string.interface_management_type_tcp_client_description),
                    onClick = { onTypeSelected("TCPClient") },
                )
                InterfaceTypeOption(
                    title = stringResource(R.string.interface_management_type_bluetooth_le),
                    description = stringResource(R.string.interface_management_type_bluetooth_le_description),
                    onClick = { onTypeSelected("AndroidBLE") },
                )
                InterfaceTypeOption(
                    title = stringResource(R.string.interface_management_type_rnode),
                ...
                Card(
                    ...
                    Row(
                        ...
                        Icon(
                            ...
                            contentDescription =
                                if (advancedExpanded) {
                                    stringResource(R.string.interface_management_collapse)
                                } else {
                                    stringResource(R.string.interface_management_expand)
                                },
                ...
                AnimatedVisibility(
                    ...
                    Column(
                        ...
                        InterfaceTypeOption(
                            title = stringResource(R.string.interface_management_type_tcp_server),
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Row(
                    ...
                    Text(
                        text = stringResource(R.string.interface_management_discovery_title),
                        style = MaterialTheme.typography.titleMedium,
                        fontWeight = FontWeight.Bold,
                        color =
                            if (isDiscoveryEnabled) {
                ...
                if (isDiscoveryEnabled) {
                        ...
                        Row(
                            ...
                            if (availableCount > 0) {
                                StatusBadge(
                                    ...
                                    label = stringResource(R.string.interface_management_discovery_status_available),
                            ...
                            if (unknownCount > 0) {
                                StatusBadge(
                                    count = unknownCount,
                                    label = stringResource(R.string.interface_management_discovery_status_unknown),
                            ...
                            if (staleCount > 0) {
                                StatusBadge(
                                    count = staleCount,
                                    label = stringResource(R.string.interface_management_discovery_status_stale),
                    ...
                    Text(
                        text = stringResource(R.string.interface_management_discovery_disabled_hint),
                        style = MaterialTheme.typography.bodyMedium,
